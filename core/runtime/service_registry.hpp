...
namespace smo::runtime {
    ...
    public:
        ...
        template <typename T> void register_service(const std::string& name, std::shared_ptr<T> instance)
        {
        ...
        template <typename T> std::shared_ptr<T> get_service(const std::string& name) const
        {
            std::lock_guard<std::mutex> lock(mutex_);
    ...
    template <typename T> void register_service(std::shared_ptr<T> instance)
    {
