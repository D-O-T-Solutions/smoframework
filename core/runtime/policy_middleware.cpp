...
namespace smo::runtime {
    ...
    PolicyMiddleware::PolicyMiddleware(smo::TrustManager* trust_mgr, smo::acl::PolicyEngine* policy_engine,
                                       NodeLifecycleFSM* lifecycle_fsm)
        : trust_mgr_(trust_mgr), policy_engine_(policy_engine), lifecycle_fsm_(lifecycle_fsm)
    {
    }
