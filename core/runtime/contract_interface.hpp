...
namespace smo::runtime {
    ...
    public:
        ...
        // Core execution
        virtual Result<ContractResult> execute(const ContractInput& input, const RuntimeContext& ctx) = 0;
    ...
    public:
        ...
        ContractCapabilities required_capabilities() const override { return metadata_.required_capabilities; }
