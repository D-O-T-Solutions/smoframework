...
namespace smo::runtime {
    ...
    {
        if (stage != MiddlewareStage::BeforeResolve)
            return {};
    ...
    {
        if (stage != MiddlewareStage::BeforeDispatch)
            return {};
    ...
    std::string TracingMiddleware::stage_to_string(MiddlewareStage s)
    {
        switch (s)
        {
        case MiddlewareStage::BeforeResolve:
            return "before_resolve";
        case MiddlewareStage::BeforeDispatch:
            return "before_dispatch";
        case MiddlewareStage::AfterDispatch:
            return "after_dispatch";
        case MiddlewareStage::AfterCommit:
            return "after_commit";
        }
        return "unknown";
    }
    ...
    {
        if (stage != MiddlewareStage::AfterDispatch)
            return {};
    ...
    {
        if (stage != MiddlewareStage::AfterCommit)
            return {};
        if (!ctx.plan_context->event_bus)
            return {};
