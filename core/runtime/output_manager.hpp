...
namespace smo::runtime {
    ...
    public:
        ...
        struct AggregatedOutput
        {
            ...
            {
                return "Executed: " + std::to_string(total) + " | Success: " + std::to_string(success) +
                       " | Denied: " + std::to_string(denied) + " | Timeout: " + std::to_string(timeout) +
                       " | Offline: " + std::to_string(offline) + " | Error: " + std::to_string(error);
            }
        };
        ...
        void add_result(const std::string& node_id, const std::string& contract_id, const std::string& execution_id,
