...
namespace smo {
    ...
    {
        return fmt::format("[{}:{}] {} (cat={}, code={}, sev={})", source_file ? source_file : "?", source_line,
                           message, static_cast<int>(code.category), code.code, static_cast<int>(code.severity));
    }
    ...
    namespace {
        ...
        struct ErrcCategory : std::error_category
        {
            ...
            std::string message(int ev) const override
            {
                ...
                case Errc::INVALID_CONTRACT:
                    return "Invalid contract";
                case Errc::INVALID_SIGNATURE:
                    return "Invalid signature";
                case Errc::INVALID_SESSION:
                    return "Invalid session";
                case Errc::INVALID_TIMESTAMP:
                    return "Invalid timestamp";
                case Errc::POLICY_DENIED:
                    return "Policy denied";
                case Errc::CAPABILITY_INSUFFICIENT:
                    return "Capability insufficient";
                case Errc::CAPABILITY_REVOKED:
                    return "Capability revoked";
                case Errc::TRUST_INSUFFICIENT:
                    return "Trust insufficient";
                case Errc::WITNESS_UNAVAILABLE:
                    return "Witness unavailable";
                case Errc::WITNESS_REJECTED:
                    return "Witness rejected";
                case Errc::EXECUTION_FAILED:
                    return "Execution failed";
                case Errc::EXECUTION_TIMEOUT:
                    return "Execution timeout";
                case Errc::OPCODE_NOT_FOUND:
                    return "Opcode not found";
                case Errc::OPCODE_NOT_IDEMPOTENT:
                    return "Opcode not idempotent";
                case Errc::CONNECTION_FAILED:
                    return "Connection failed";
                case Errc::SESSION_EXPIRED:
                    return "Session expired";
                case Errc::REPLAY_DETECTED:
                    return "Replay detected";
                case Errc::STORE_UNAVAILABLE:
                    return "Store unavailable";
                case Errc::STORE_CORRUPTION:
