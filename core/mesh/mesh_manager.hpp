...
namespace smo {
    ...
    public:
        ...
        // Enrollment
        Result<std::string> generate_invite(const std::string& mesh_id, const std::string& role,
        ...
        Result<void> publish_mesh(const std::string& mesh_id, const std::string& listen_address,
