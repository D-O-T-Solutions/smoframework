...
namespace smo::enroll {
    ...
    [[deprecated("Use generate_token with admission+signature instead")]] Result<JoinToken>
    generate_token_hmac(const std::string& mesh_id, int64_t mesh_epoch, int cipher_suite_id,
