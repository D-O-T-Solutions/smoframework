...
namespace smo::acl {
    ...
    namespace presets {
        ...
        inline const acl::PolicySet ENTERPRISE_STANDARD = {"enterprise-standard",
        ...
        // Read-only policy
        inline const acl::PolicySet READONLY = {"readonly",
        ...
        inline const acl::PolicySet BACKUP = {"backup",
                                              "Backup operations policy",
                                              {
                                                  {"require-certificate",
                                                   "Require valid certificate",
        ...
        // Compliance policy
        inline const acl::PolicySet COMPLIANCE = {"compliance",
