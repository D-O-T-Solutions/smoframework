...
namespace smo {
    ...
    namespace DiscoveryErrc {
        inline constexpr ErrorCode PeerNotFound(ErrorCategory::Discovery, 400, Severity::Info, RetryClass::RetrySafe,
                                                Recovery::None);
        inline constexpr ErrorCode PeerUnreachable(ErrorCategory::Discovery, 401, Severity::Warn,
                                                   RetryClass::RetryBackoff, Recovery::None);
        inline constexpr ErrorCode PeerSuspect(ErrorCategory::Discovery, 402, Severity::Info, RetryClass::RetrySafe,
                                               Recovery::None);
        inline constexpr ErrorCode PeerTimeout(ErrorCategory::Discovery, 403, Severity::Warn, RetryClass::NoRetry,
                                               Recovery::None);
        inline constexpr ErrorCode MembershipTableFull(ErrorCategory::Discovery, 405, Severity::Warn,
                                                       RetryClass::NoRetry, Recovery::None);
        inline constexpr ErrorCode BootstrapNoSeeds(ErrorCategory::Discovery, 406, Severity::Error,
                                                    RetryClass::RetryBackoff, Recovery::ManualIntervention);
    } // namespace DiscoveryErrc
    ...
    public:
        ...
        static Result<PeerRecord> find_seed(const std::vector<Endpoint>& seeds, Transport& transport,
    ...
    Result<void> dispatch_discovery_datagram(BytesView data, class DiscoveryEngine& engine, const Endpoint& from,
                                             int64_t now_ns);
