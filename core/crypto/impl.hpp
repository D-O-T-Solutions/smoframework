...
namespace smo {
    ...
    struct AeadImpl
    {
        Result<Bytes> (*encrypt)(BytesView plaintext, BytesView aad, BytesView key, BytesView nonce) = nullptr;
        Result<Bytes> (*decrypt)(BytesView ciphertext, BytesView aad, BytesView key, BytesView nonce) = nullptr;
    };
    ...
    struct KemImpl
    {
        ...
        Result<Bytes> (*decapsulate)(BytesView privkey, BytesView ciphertext) = nullptr;
    };
    ...
    {
        Result<KeypairResult> (*generate_keypair)(RngRef& rng) = nullptr;
        Result<Bytes> (*sign)(BytesView msg, BytesView secret_key, RngRef& rng) = nullptr;
        Result<bool> (*verify)(BytesView msg, BytesView signature, BytesView public_key) = nullptr;
    };
