...
namespace smo {
    ...
    // ===========================================================================
    namespace TrustErrc {
        inline constexpr ErrorCode ScoreUnavailable(ErrorCategory::Trust, 200, Severity::Info, RetryClass::RetrySafe,
                                                    Recovery::None);
        inline constexpr ErrorCode BelowThreshold(ErrorCategory::Trust, 201, Severity::Info, RetryClass::NoRetry,
                                                  Recovery::None);
        inline constexpr ErrorCode PenaltyApplied(ErrorCategory::Trust, 202, Severity::Info, RetryClass::NoRetry,
                                                  Recovery::None);
        inline constexpr ErrorCode DigestInvalid(ErrorCategory::Trust, 203, Severity::Warn, RetryClass::NoRetry,
                                                 Recovery::None);
        inline constexpr ErrorCode DigestStale(ErrorCategory::Trust, 204, Severity::Info, RetryClass::NoRetry,
                                               Recovery::None);
        inline constexpr ErrorCode WitnessSelectionFailed(ErrorCategory::Trust, 205, Severity::Warn,
                                                          RetryClass::RetrySafe, Recovery::RestartFSM);
        inline constexpr ErrorCode AttestationInvalid(ErrorCategory::Trust, 206, Severity::Error, RetryClass::NoRetry,
                                                      Recovery::None);
        inline constexpr ErrorCode AttestationConflict(ErrorCategory::Trust, 207, Severity::Warn, RetryClass::NoRetry,
                                                       Recovery::None);
        inline constexpr ErrorCode AttestationExpired(ErrorCategory::Trust, 208, Severity::Warn, RetryClass::NoRetry,
                                                      Recovery::None);
    } // namespace TrustErrc
    ...
    struct TrustAnchor
    {
        ...
        bool operator==(const TrustAnchor& o) const noexcept { return node_id == o.node_id; }
    };
