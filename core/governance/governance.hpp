...
namespace smo {
    ...
    namespace GovernanceErrc {
        inline constexpr ErrorCode AuthorityNotFound(ErrorCategory::Governance, 800, Severity::Error,
                                                     RetryClass::NoRetry, Recovery::GovernanceVote);
        inline constexpr ErrorCode AuthorityNotAuthorized(ErrorCategory::Governance, 801, Severity::Error,
                                                          RetryClass::NoRetry, Recovery::GovernanceVote);
        inline constexpr ErrorCode ThresholdNotMet(ErrorCategory::Governance, 803, Severity::Warn, RetryClass::NoRetry,
                                                   Recovery::GovernanceVote);
        inline constexpr ErrorCode ProposalInvalid(ErrorCategory::Governance, 810, Severity::Error, RetryClass::NoRetry,
                                                   Recovery::None);
        inline constexpr ErrorCode EpochIncrementFailed(ErrorCategory::Governance, 807, Severity::Critical,
                                                        RetryClass::NoRetry, Recovery::ManualIntervention);
        inline constexpr ErrorCode UnanimousRequired(ErrorCategory::Governance, 811, Severity::Error,
                                                     RetryClass::NoRetry, Recovery::ManualIntervention);
        inline constexpr ErrorCode ProposalConflict(ErrorCategory::Governance, 812, Severity::Warn, RetryClass::NoRetry,
                                                    Recovery::GovernanceVote);
        inline constexpr ErrorCode ActionNotAllowed(ErrorCategory::Governance, 813, Severity::Error,
                                                    RetryClass::NoRetry, Recovery::ManualIntervention);
    } // namespace GovernanceErrc
    ...
    struct GovernanceProposal
    {
        ...
        bool threshold_met() const noexcept { return static_cast<int>(signatures.size()) >= threshold; }

        bool is_expired(int64_t now) const noexcept { return expires_at > 0 && now >= expires_at; }
    ...
    inline MeshHealth compute_health(uint32_t total, uint32_t online, uint32_t min_req, uint32_t preferred,
                                     uint32_t maximum)
    {
        MeshHealth h;
