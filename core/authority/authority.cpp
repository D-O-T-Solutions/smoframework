...
namespace smo::authority {
    ...
    public:
        ...
        bool has_authority_key() const { return !authority_public_key_.empty() && !authority_secret_key_.empty(); }
    ...
    Result<Certificate> MeshAuthority::sign_csr(BytesView csr_blob, const std::string& mesh_id)
    {
        ...
        if (registry_)
        {
            ...
            auto enroll = registry_->enroll_node(node_id_hex, normalized, mesh_id, "Reader", fp_hex,
