...
inline const char* tree_name(TreeID id) {
    switch (id) {
        case TreeID::Membership: return "membership";
        case TreeID::CRL:        return "crl";
        case TreeID::Policy:     return "policy";
        case TreeID::Contract:   return "contract";
    }
    return "unknown";
}
...
inline uint32_t tree_bucket_count(TreeID id) {
    switch (id) {
        case TreeID::Membership: return 256;
        case TreeID::CRL:        return 256;
        case TreeID::Policy:     return 64;
        case TreeID::Contract:   return 64;
    }
    return 0;
}
