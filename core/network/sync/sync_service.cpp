...
namespace smo::sync {
    ...
    struct SyncService::Impl
    {
        ...
        Impl(GossipEngine& g, recovery::CRL* c, SyncSchedule s) : gossip(g), crl(c), schedule(s) {}
    ...
    SyncService::SyncService(GossipEngine& gossip, recovery::CRL* crl, SyncSchedule schedule)
