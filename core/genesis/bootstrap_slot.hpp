...
namespace smo::genesis {
    ...
    struct BootstrapSlot
    {
        ...
        bool is_expired(uint64_t now_ns) const { return expires_at > 0 && now_ns > expires_at; }
    ...
    struct SlotRing
    {
        ...
        // ── Mutators ──
        Result<uint32_t> claim_slot(const std::string& role, const std::string& node_public_key,
