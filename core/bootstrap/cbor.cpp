...
namespace smo::cbor {
    ...
    Result<uint64_t> Decoder::decode_head(uint8_t& major_out)
    {
        ...
        case 27:
            ...
            break;
        default:
            return SMO_ERR_PROTOCOL(701, Error, NoRetry, None, "CBOR: reserved additional info");
        }

        if (pos_ + extra > data_.size())
        {
            return SMO_ERR_PROTOCOL(700, Error, NoRetry, None, "CBOR: truncated additional info");
        }
    ...
    Result<uint64_t> Decoder::decode_uint()
    {
        ...
        if (major != 0)
        {
            return SMO_ERR_PROTOCOL(702, Error, NoRetry, None, "CBOR: expected unsigned integer");
        }
        return val;
    }
    ...
    Result<int64_t> Decoder::decode_int()
    {
        ...
        return SMO_ERR_PROTOCOL(703, Error, NoRetry, None, "CBOR: expected integer");
    }
    ...
    Result<BytesView> Decoder::decode_bytes()
    {
        ...
        if (major != 2)
        {
            return SMO_ERR_PROTOCOL(704, Error, NoRetry, None, "CBOR: expected byte string");
        }
        size_t n = static_cast<size_t>(len.value());
        if (pos_ + n > data_.size())
        {
            return SMO_ERR_PROTOCOL(700, Error, NoRetry, None, "CBOR: truncated byte string");
        }
    ...
    Result<std::string> Decoder::decode_string()
    {
        ...
        if (major != 3)
        {
            return SMO_ERR_PROTOCOL(705, Error, NoRetry, None, "CBOR: expected text string");
        }
        size_t n = static_cast<size_t>(len.value());
        if (pos_ + n > data_.size())
        {
            return SMO_ERR_PROTOCOL(700, Error, NoRetry, None, "CBOR: truncated text string");
        }
    ...
    Result<size_t> Decoder::decode_array_size()
    {
        ...
        if (major != 4)
        {
            return SMO_ERR_PROTOCOL(706, Error, NoRetry, None, "CBOR: expected array");
        }
    ...
    Result<size_t> Decoder::decode_map_size()
    {
        ...
        if (major != 5)
        {
            return SMO_ERR_PROTOCOL(707, Error, NoRetry, None, "CBOR: expected map");
        }
        return static_cast<size_t>(len.value());
    }
    ...
    Result<void> Decoder::skip()
    {
        if (pos_ >= data_.size())
        {
            return SMO_ERR_PROTOCOL(700, Error, NoRetry, None, "CBOR: unexpected end during skip");
        }
    ...
    static Result<uint64_t> decode_uint_field_at_offset(Decoder& dec, uint64_t target_key)
    {
        ...
        return SMO_ERR_PROTOCOL(709, Error, NoRetry, None, "CBOR: field " + std::to_string(target_key) + " not found");
    }
    ...
    Result<std::string> decode_string_field(Decoder& dec, uint64_t target_key)
    {
        ...
        return SMO_ERR_PROTOCOL(709, Error, NoRetry, None, "CBOR: field not found");
    }
