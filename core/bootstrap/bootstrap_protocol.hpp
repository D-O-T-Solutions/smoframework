...
namespace smo::bootstrap {
    ...
    inline constexpr uint32_t kOpcodeBootstrapRequest =
        static_cast<uint32_t>(kNamespaceBootstrap) | (static_cast<uint32_t>(kMsgBootstrapRequest) << 8);
    inline constexpr uint32_t kOpcodeBootstrapResponse =
        static_cast<uint32_t>(kNamespaceBootstrap) | (static_cast<uint32_t>(kMsgBootstrapResponse) << 8);
