...
namespace smo::bootstrap {
    ...
    Result<BootstrapRequest> BootstrapRequest::decode_cbor(BytesView data)
    {
        ...
        {
            return SMO_ERR_PROTOCOL(900, Error, NoRetry, None, "BootstrapRequest missing node_id");
        }
                                                       ...
                                                       GovernanceEngine* governance, recovery::CRL* crl)
    {
        ...
        if (!mesh_res)
        {
            return SMO_ERR_PROTOCOL(900, Error, NoRetry, None, "No active mesh for bootstrap");
        }
        ...
        // Supported opcodes
        snap.opcodes = {static_cast<uint8_t>(Opcode::LS),
        ...
        // Genesis manifest (minimal CBOR)
        {
            ...
            man_enc.encode_string(cfg.root_pubkey);
            man_enc.encode_uint(3);
            man_enc.encode_uint(static_cast<uint64_t>(cfg.epoch));
