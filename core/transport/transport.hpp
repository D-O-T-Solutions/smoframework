...
namespace smo {
    ...
    namespace TransportErrc {
        inline constexpr ErrorCode ConnectionRefused(ErrorCategory::Transport, 300, Severity::Error,
                                                     RetryClass::RetryBackoff, Recovery::Reconnect);
        inline constexpr ErrorCode ConnectionTimeout(ErrorCategory::Transport, 301, Severity::Error,
                                                     RetryClass::RetryBackoff, Recovery::Reconnect);
        inline constexpr ErrorCode ConnectionReset(ErrorCategory::Transport, 302, Severity::Warn, RetryClass::RetrySafe,
                                                   Recovery::Reconnect);
        inline constexpr ErrorCode ConnectionClosed(ErrorCategory::Transport, 303, Severity::Info, RetryClass::NoRetry,
                                                    Recovery::None);
        inline constexpr ErrorCode WriteFailed(ErrorCategory::Transport, 304, Severity::Error, RetryClass::RetrySafe,
                                               Recovery::Reconnect);
        inline constexpr ErrorCode ReadFailed(ErrorCategory::Transport, 305, Severity::Error, RetryClass::RetrySafe,
                                              Recovery::Reconnect);
        inline constexpr ErrorCode ListenFailed(ErrorCategory::Transport, 306, Severity::Error, RetryClass::NoRetry,
                                                Recovery::RestartFSM);
        inline constexpr ErrorCode AddressInUse(ErrorCategory::Transport, 307, Severity::Warn, RetryClass::NoRetry,
                                                Recovery::RestartFSM);
        inline constexpr ErrorCode DnsResolveFailed(ErrorCategory::Transport, 308, Severity::Error, RetryClass::NoRetry,
                                                    Recovery::Reconnect);
        inline constexpr ErrorCode FrameTooLarge(ErrorCategory::Transport, 309, Severity::Warn, RetryClass::NoRetry,
                                                 Recovery::RestartFSM);
        inline constexpr ErrorCode FrameTruncated(ErrorCategory::Transport, 310, Severity::Warn, RetryClass::NoRetry,
                                                  Recovery::RestartFSM);
        inline constexpr ErrorCode VersionNegotiationFailed(ErrorCategory::Transport, 312, Severity::Error,
                                                            RetryClass::NoRetry, Recovery::Reconnect);
        inline constexpr ErrorCode VersionMismatch(ErrorCategory::Transport, 313, Severity::Warn, RetryClass::NoRetry,
                                                   Recovery::Reenroll);
        inline constexpr ErrorCode BufferExhausted(ErrorCategory::Transport, 314, Severity::Error,
                                                   RetryClass::RetryBackoff, Recovery::RestartFSM);
    } // namespace TransportErrc
