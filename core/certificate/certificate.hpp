...
namespace smo {
    ...
    public:
        ...
        bool is_valid_at(int64_t timestamp) const noexcept { return timestamp >= not_before && timestamp <= not_after; }
    };
    ...
    public:
        ...
        Result<void> sign(const SignerImpl& signer, BytesView secret_key, RngRef& rng);
    };
