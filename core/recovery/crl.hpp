...
namespace smo::recovery {
    ...
    public:
        ...
        Result<void> revoke(const std::string& cert_fingerprint, const std::string& node_id_hex,
        ...
        bool is_epoch_invalid(uint64_t cert_epoch, uint64_t current_epoch) const { return cert_epoch < current_epoch; }
