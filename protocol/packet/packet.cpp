...
namespace smo {
    ...
    Result<Packet> packet_from_buffer(std::span<const uint8_t> wire)
    {
        ...
        {
            return SMO_ERR_PROTOCOL(600, Error, NoRetry, None, "truncated packet header");
        }
        ...
        {
            return SMO_ERR_PROTOCOL(602, Error, NoRetry, None, "payload length exceeds wire buffer");
        }
