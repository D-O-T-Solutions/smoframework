...
namespace smo {
    ...
    ExecutionResult Runtime::execute(const ContractID& id, const ExecutionContext& ctx)
    {
        ...
        if (!abi_opt)
        {
            ...
            err.success = false;
            err.contract_id = id;
            err.errors.push_back(SMO_ERR_RUNTIME(14, Error, NoRetry, None, "no ABI registered for contract"));
            return err;
        }
