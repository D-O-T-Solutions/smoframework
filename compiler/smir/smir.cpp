...
namespace smo {
    ...
    static const char* smir_opcode_name(SmirOpcode op)
    {
        ...
        case SmirOpcode::Nop:
            return "nop";
        case SmirOpcode::Call:
            return "call";
        case SmirOpcode::Load:
            return "load";
        case SmirOpcode::Store:
            return "store";
        case SmirOpcode::Cond:
            return "cond";
        case SmirOpcode::Seq:
            return "seq";
        case SmirOpcode::Parallel:
            return "parallel";
        case SmirOpcode::BindInput:
            return "bind_input";
        case SmirOpcode::BindOutput:
            return "bind_output";
        case SmirOpcode::Literal:
            return "literal";
        case SmirOpcode::Move:
            return "move";
        case SmirOpcode::Assert:
            return "assert";
        case SmirOpcode::Debug:
            return "debug";
        }
        return "unknown";
    }
    ...
    static std::string operand_str(const SmirOperand& op)
    {
        switch (op.type)
        {
        case SmirOperand::Literal:
            return "\"" + op.value + "\"";
        case SmirOperand::Identifier:
            return "%" + op.value;
        case SmirOperand::Temp:
            return "$" + op.value;
        default:
            return "_";
        }
