...
bool RelayManager::create_relay_session(const std::string& sender_id, const std::string& target_id,
                                        const std::string& relay_via_id, const std::string& relay_via_ip,
...
std::pair<PacketHeader, std::vector<uint8_t>>
RelayManager::unpack_relay_packet(const std::vector<uint8_t>& relay_payload)
{
...
std::vector<uint8_t> RelayManager::pack_relay_request(const std::string& target_id, const PacketHeader& hdr,
